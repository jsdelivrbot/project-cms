    ...
    return function t(e, r, n) {
      ...
      11: [function(e, t, r) {
        ...
        t.exports = function(e, t) {
          ...
          if (60 === e.src.charCodeAt(t)) {
            for (t++; a > t; ) {
              if (r = e.src.charCodeAt(t), 10 === r)
                return !1;
              if (62 === r)
                return i = n(s(e.src.slice(l + 1, t))), e.parser.validateLink(i) ? (e.pos = t + 1, e.linkContent = i, !0) : !1;
              92 === r && a > t + 1 ? t += 2 : t++;
            }
            return !1;
          }
      ...
      19: [function(e, t, r) {
        ...
        n.prototype.__find__ = function(e) {
          for (var t = this.__rules__.length,
              r = -1; t--; )
      ...
      23: [function(e, t, r) {
        ...
        t.exports = function(e, t, r, o) {
          var i,
              ...
              k;
          if (o)
            return e.ddIndent < 0 ? !1 : n(e, t) >= 0;
          if (h = t + 1, e.isEmpty(h) && ++h > r)
            return !1;
          ...
          if (a = e.src.charCodeAt(p + 1), 33 === a || 63 === a) {
            ...
            if (47 === a) {
              if (c = e.src.slice(p, h).match(i), !c)
                return !1;
            } else if (c = e.src.slice(p, h).match(o), !c)
              return !1;
            if (s[c[1].toLowerCase()] !== !0)
              return !1;
            if (l)
              return !0;
          }
      ...
      32: [function(e, t, r) {
        ...
        n.prototype.isEmpty = function(e) {
          ...
          if (e >= t)
            return "";
          if (c + 1 === t)
            return o = this.bMarks[c] + Math.min(this.tShift[c], r), i = n ? this.eMarks[c] + 1 : this.eMarks[c], this.src.slice(o, i);
      ...
      34: [function(e, t, r) {
        ...
        function n(e, t, r, n) {
          ...
          if (-1 === e.indexOf("]:"))
            return -1;
          if (i = new s(e, t, r, n, []), l = o(i, 1), 0 > l || 58 !== e.charCodeAt(l + 1))
            return -1;
                ...
                for (a = v[r].children, g = 0, t = a.length - 1; t >= 0; t--)
                  if (c = a[t], "link_close" !== c.type) {
                    if ("htmltag" === c.type && (n(c.content) && g > 0 && g--, s(c.content) && g++), !(g > 0) && "text" === c.type && l.test(c.content)) {
                      if (k || (k = o(), m = k.links, b = k.autolinker), u = c.content, m.length = 0, b.link(u), !m.length)
                        continue;
      ...
      40: [function(e, t, r) {
        ...
        function n(e, t, r, n) {
          ...
          if (-1 === e.indexOf("]:"))
            return -1;
          if (c = new s(e, t, r, n, []), u = o(c, 0), 0 > u || 58 !== e.charCodeAt(u + 1))
            return -1;
          ...
          for (g = c.linkContent, p = c.pos, d = p, p += 1; h > p && (f = c.src.charCodeAt(p), 32 === f || 10 === f); p++)
            ;
          for (h > p && d !== p && l(c, p) ? (m = c.linkContent, p = c.pos) : (m = "", p = d); h > p && 32 === c.src.charCodeAt(p); )
            p++;
                  ...
                  if (r = y[t], "text" === r.type && !o.test(r.text)) {
                    ...
                    e: for (; p > u && (i.lastIndex = u, c = i.exec(l)); )
                      if (f = !n(l, c.index - 1), u = c.index + 1, k = "'" === c[0], d = !n(l, u), d || f) {
                        ...
                        k && (r.content = s(r.content, c.index, a));
                  }
        };
      }, {}],
      43: [function(e, t, r) {
      ...
      46: [function(e, t, r) {
        ...
        function s(e, t) {
          ...
          for (r = t > 0 ? e.src.charCodeAt(t - 1) : -1; c > i && e.src.charCodeAt(i) === u; )
            i++;
          ...
          if (h > p + 1)
            if (r = e.src.charCodeAt(p + 1), 35 === r) {
              if (u = e.src.slice(p).match(l))
                return t || (c = "x" === u[1][0].toLowerCase() ? parseInt(u[1].slice(1), 16) : parseInt(u[1], 10), e.pending += i(o(c) ? c : 65533)), e.pos += u[0].length, !0;
        ...
        t.exports = function(e, t) {
          ...
          if (p = l + 1, m > p && 40 === e.src.charCodeAt(p)) {
            ...
            for (; m > p && (f = e.src.charCodeAt(p), 32 === f || 10 === f); p++)
              ;
            if (m > p && 91 === e.src.charCodeAt(p) && (b = p + 1, p = n(e, p), p >= 0 ? a = e.src.slice(b, p++) : p = b - 1), a || ("undefined" == typeof a && (p = l + 1), a = e.src.slice(r, l)), h = e.env.references[i(a)], !h)
              return e.pos = g, !1;
            c = h.href, u = h.title;
          }
        ...
        !function(t, s) {
          ...
          return e.prototype = {
            ...
            createMatchReturnVal: function(t) {
              var r;
              if (this.replaceFn && (r = this.replaceFn.call(this, this, t)), "string" == typeof r)
                return r;
              if (r === !1)
            ...
            parseTextAndEntityNodes: function(t) {
              for (var r = [],
                  n = e.Util.splitAndCapture(t, this.htmlCharacterEntitiesRegex),
                  s = 0,
                  o = n.length; o > s; s += 2) {
                var i = n[s],
                    l = n[s + 1];
