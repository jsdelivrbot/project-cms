...
const tap = require('tap'),
    ...
    AbstractLevelDOWN = require('../abstract-leveldown@0.12.3.json!systemjs-json').AbstractLevelDOWN,
    AbstractIterator = require('../abstract-leveldown@0.12.3.json!systemjs-json').AbstractIterator,
    AbstractChainedBatch = require('../abstract-leveldown@0.12.3.json!systemjs-json').AbstractChainedBatch;
