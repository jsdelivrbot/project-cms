...
(function(Buffer) {
  ...
  test('deeper handles all the edge cases', function(t) {
    ...
    t.ok(d(heinous, awful), 'mutual recursion with otherwise identical structures fools deepEquals');
    ...
    t.notOk(d(function nop() {}, function nop() {}), 'functions are only the same by reference');
