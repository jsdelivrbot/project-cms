  ...
  !function(a, b) {
    ...
    return a.prototype = {
      ...
      parse: function(a) {
        for (var b,
          ...
          var g = b[0],
              h = b[1] || b[3],
              i = !!b[2],
              j = a.substring(e, b.index);
          j && (c = this.parseTextAndEntityNodes(j), f.push.apply(f, c)), f.push(this.createElementNode(g, h, i)), e = b.index + g.length;
        }
        if (e < a.length) {
          var k = a.substring(e);
          k && (c = this.parseTextAndEntityNodes(k), f.push.apply(f, c));
        }
        return f;
      },
      ...
      replace: function(a, b, c) {
        var d = this;
        return a.replace(this.matcherRegex, function(a, e, f, g, h, i, j, k, l) {
          var m = d.processCandidateMatch(a, e, f, g, h, i, j, k, l);
          if (m) {
            var n = b.call(c, m.match);
            return m.prefixStr + n + m.suffixStr;
          }
          return a;
        });
      },
      processCandidateMatch: function(b, c, d, e, f, g, h, i, j) {
        ...
        if (this.matchHasUnbalancedClosingParen(b) && (b = b.substr(0, b.length - 1), n = ")"), f)
          ...
          d && (m = d, b = b.slice(1)), k = new a.match.Twitter({
            matchedText: b,
            twitterHandle: e
          });
        else {
