...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {development: {
        ...
        src: ['src/Autolinker.js', 'src/Util.js', 'src/HtmlTag.js', 'src/AnchorTagBuilder.js', 'src/htmlParser/HtmlParser.js', 'src/htmlParser/HtmlNode.js', 'src/htmlParser/ElementNode.js', 'src/htmlParser/EntityNode.js', 'src/htmlParser/TextNode.js', 'src/matchParser/MatchParser.js', 'src/matchParser/MatchValidator.js', 'src/match/Match.js', 'src/match/Email.js', 'src/match/Twitter.js', 'src/match/Url.js'],
        dest: distPath
      }},
    uglify: {production: {
